 ...
 */
public class RightBeam {

    public static void  buildPosGauss(XYChart chart, double count, double lensPos) {

        double center, tmp1, tmp2, y;
        double radius;

        for(double i = count; i < lensPos; i += count) {
    ...
    public static void  buildNegGauss(XYChart chart, double count, double lensPos) {
